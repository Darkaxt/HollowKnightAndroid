...
class ProfileModPipelineContractTest(unittest.TestCase):
    ...
    def test_silksong_mods_are_process_owned_and_reachable_from_ds_port(self):
        ...
        self.assertIn("new LineFileTweakStore", runtime)
        self.assertIn('ProfilePath(Application.persistentDataPath, "silksong")', runtime)
        self.assertNotIn("new PlayerPrefsTweakStore", runtime)
