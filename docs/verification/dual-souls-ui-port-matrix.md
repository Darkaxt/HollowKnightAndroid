...
| Shared Silksong skins/death rotation | Task101 — `HOST-COMPLETE / DEVICE-DEFERRED` at `bcf3508` | Closed 11-target Silksong catalog/profile; exact multi-instance tk2d collection/material admission across default/active/windy/crest and persistent HUD ownership; character-only ROTATE; persistent HUD ON; complete sparse-target omissions; retry-owned teardown; bounded ordered death retention; and exact pinned post-normalization `HeroController.<Die>d__1101.MoveNext` classification. Executable host regressions cover startup-before-disabled-return, teardown retry ownership, multiple deaths before polling/while apply is pending, same-hero library swaps, all omissions, and profile-aware launcher output. The host checkpoint passes 1,565 shared, 97 launcher, 142 Python, and 38 BundleSurgery tests; compiles 82 Silksong sources against exact 1.0.29980 and preserves the exact Hollow Knight compile. The death rewrite accepts only Assembly-CSharp SHA-256 `1af095416b89f73993058f9cbac3a93959d928314b735cc4acbca7bf1a952d2d`, produces canonical SHA-256 `37cd088f4de464b4cc7b01b193ac294a3dfeb282d1fa1757a653215d514db634`, is byte-idempotent, and rejects original or already-bridged unrelated drift without output. Android bundle identity/parity, sampled material appearance, Scythe/Shaman shader behavior, crest/fallback visuals, HUD effects, resource pressure, death/respawn visuals/lifecycle, and persistence interaction remain device-only. Evidence: `docs/verification/evidence/task101-spec-fix-bcf3508/` (supersedes `task101-host-0b92f4d`) |
