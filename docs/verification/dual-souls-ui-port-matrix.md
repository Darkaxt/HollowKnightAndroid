...
| Shared Silksong skins/death rotation | Task101 — `HOST-COMPLETE / DEVICE-DEFERRED` at `90fd450`, superseding `1791586` | Closed 11-target Silksong catalog/profile with exact dimensions; exact multi-instance tk2d admission; character-only ROTATE and persistent HUD ON; sparse omissions; retry-owned teardown; durable Kotlin rotation-run authority; bounded ordered per-occurrence death ownership; and exact pinned post-normalization classification. Pending rotation now acquires lightweight hero/manager/HUD/library/collection identities on a one-second throttle and forces one invalidation-driven visual refresh, breaking the stable-respawn dependency without steady hierarchy traversal. The 484 MiB ON and 352 MiB ROTATE packs use restore → retire → confirmed Unity fake-null release → successor allocation under the 512 MiB bound; no successor mode is claimed while old ON/HUD visuals remain. Restore-complete retirement waits now publish vanilla/no active pack immediately while preserving the frozen successor retry, including when sparse/live-subset discovery appends omission diagnostics; target waits that genuinely retain old character visuals and failed restorations retain their truthful old active identity. BundleSurgery still requires original SHA-256 `1af095416b89f73993058f9cbac3a93959d928314b735cc4acbca7bf1a952d2d` and canonical bridge SHA-256 `86e8ffd402bb5e58c57d89ef2e0c3fa8dd3e89a9c1c049d4bf663484434b6a8e`, then structurally verifies the final post-save/post-UIMsg/post-Mods assembly and binds its hash/result to conversion provenance. The exact no-Mod downstream final is `fee81c9bfee10dea307373b167f717d0b4aa5811c2e849ef9a4cf98c7804a2a0`; stripped and moved call sites fail closed. Host validation passes 1,579 shared, 104 selected launcher, 151 Python, and 40 BundleSurgery tests; exact compiles cover 83 Silksong sources/14 entry points and Hollow Knight 1.5.12620/2 entry points. Android/Unity/GPU/JNI/device visual and lifecycle acceptance remains deferred. Evidence: `docs/verification/evidence/task101-publish-fix-90fd450/` |
