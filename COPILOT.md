...
```sh
F=/sdcard/Android/data/io.github.darkaxt.dualsouls/files/dualscreen_v2
...
adb pull /sdcard/Android/data/io.github.darkaxt.dualsouls/files/sprites

adb shell "rm -f $F"                 # back to normal

adb shell am force-stop io.github.darkaxt.dualsouls   # settings are read once per process
