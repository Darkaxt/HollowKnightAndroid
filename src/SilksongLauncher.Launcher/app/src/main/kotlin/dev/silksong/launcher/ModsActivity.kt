...
// it applied, and every one it could not. A toggle turns a plugin off without
// deleting it, and turning one off is the same kind of change as adding one --
// it needs a rebuild, and the screen says so rather than letting the next
// launch quietly be the old build.
        ...
        header.addView(
            Switch(this).apply {
                ...
                setOnCheckedChangeListener { _, checked ->
                    Mods.setEnabled(mods, relative, checked)
