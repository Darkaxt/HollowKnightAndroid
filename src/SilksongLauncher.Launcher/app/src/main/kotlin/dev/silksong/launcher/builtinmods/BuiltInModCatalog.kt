...
object BuiltInModCatalog {
    ...
    val silksong = listOf(
        ...
        available("fast_transitions", "fast_transitions", BuiltInModControlKind.Choice, "WORLD", "FAST TRANSITIONS", "Shorten supported scene transitions.", "off", listOf("off", "on")),
        available("auto_map", "auto_map", BuiltInModControlKind.Choice, "WORLD", "AUTO MAP", "Reveal visited rooms on the map automatically.", "off", listOf("off", "on")),
        available("innate_compass", "innate_compass", BuiltInModControlKind.Choice, "WORLD", "INNATE COMPASS", "Show Hornet on the map without requiring a compass tool.", "off", listOf("off", "on")),
        available("bench_teleport", "bench_teleport", BuiltInModControlKind.Route, "WORLD", "BENCH TELEPORT", "Open the recorded-bench destination list.", "open", listOf("open")),
        available("secret_radar", "secret_radar", BuiltInModControlKind.Choice, "WORLD", "SECRET RADAR", "Signal nearby secrets without changing progression.", "off", listOf("off", "on")),

        available("nail_damage", "nail_damage", BuiltInModControlKind.Choice, "COMBAT", "NEEDLE DAMAGE", "Multiply Needle damage while preserving upgrades.", "x1", listOf("x1", "x2", "x3", "x5")),
        ...
        available("charm_costs", "charm_costs", BuiltInModControlKind.Choice, "CRESTS & TOOLS", "TOOL COSTS", "Remove Tool replenishment costs while enabled.", "vanilla", listOf("vanilla", "free")),
        available("unlimited_notches", "unlimited_notches", BuiltInModControlKind.Choice, "CRESTS & TOOLS", "UNLIMITED TOOL SLOTS", "Equip Tools without the normal Crest slot limit.", "off", listOf("off", "on")),
        ...
        available("geo_magnet", "geo_magnet", BuiltInModControlKind.Choice, "ECONOMY", "ROSARY MAGNET", "Collect nearby Rosaries without requiring a Tool.", "off", listOf("off", "on")),
        available("keep_geo_on_death", "keep_geo_on_death", BuiltInModControlKind.Choice, "ECONOMY", "KEEP ROSARIES ON DEATH", "Keep Rosaries through death without duplicate recovery awards.", "off", listOf("off", "on")),
        available("journal_one_kill", "journal_one_kill", BuiltInModControlKind.Choice, "ECONOMY", "JOURNAL IN ONE KILL", "Complete eligible Journal entries after one kill.", "off", listOf("off", "on")),
        available("geo_multiplier", "geo_multiplier", BuiltInModControlKind.Choice, "ECONOMY", "ROSARY MULTIPLIER", "Multiply supported Rosary awards.", "x1", listOf("x1", "x2", "x3", "x5")),
